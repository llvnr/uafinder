...
<head>
    ...
    <meta name="description" content="Un service qui vous permet d'obtenir votre user agent.">
    <title>UAGT - Un service qui vous peremt d'obtenir votre user agent.</title>
